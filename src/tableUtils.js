...
export const processDataForSucceededProposalStatusPieChart = (jsonData) => {
  let totalCosts = 0;
  ...
  const succeededCounts = jsonData.reduce((acc, item) => {
    if (item.Outcome === "Succeeded") {
      ...
      console.log("True cost for a Succeeded item:", trueCost); // Log each true cost
...
export const processDataCategoryForPieChart = (jsonData) => {
